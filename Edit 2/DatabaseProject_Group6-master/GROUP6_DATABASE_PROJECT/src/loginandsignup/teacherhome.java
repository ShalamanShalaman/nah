...
public class teacherhome extends javax.swing.JFrame {
    ...
    try (Connection con = DriverManager.getConnection(SUrl, SUser, SPass)) {
      Statement st = con.createStatement();
      String query = "INSERT INTO grading(gradeid, quarter, studentid, name, math, science, english, hekasi, he ,pe) VALUES('" + gid + "', '" + quart + "', '"  + id + "', '" + name + "', '" + math2 + "', '" + english2 + "', '" + science2 + "', '" + hekasi2 + "', '" + he2 + "', '" + pe2  + "')";
